...
const driving_school_settings_entity_1 = require("./driving-school-settings.entity");
...
], DrivingSchoolEntity.prototype, "mebbis_credentials_locked", void 0);
__decorate([
    (0, typeorm_1.Column)(),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => driving_school_settings_entity_1.DrivingSchoolSettingsEntity, (settings) => settings.driving_school, { nullable: true }),
    __metadata("design:type", driving_school_settings_entity_1.DrivingSchoolSettingsEntity)
], DrivingSchoolEntity.prototype, "settings", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => subscription_entity_1.SubscriptionEntity, subscription => subscription.driving_school),
