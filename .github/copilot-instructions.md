...
**CRITICAL**: The desktop app uses **Electron v22.x** for compatibility. Always ensure:
- Desktop `package.json` maintains `electron` dependency at `^22.0.0`
- All Electron APIs used must be compatible with v22
- When updating desktop dependencies, verify v22 compatibility before upgrading
